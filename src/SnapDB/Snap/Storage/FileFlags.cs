...
public static class FileFlags
{
    ...
    /// </summary>
    public static readonly Guid Stage0 = new(0x4558f270, 0x3f85, 0x456c, 0x88, 0x24, 0x78, 0x05, 0xff, 0x03, 0xb3, 0x84);
    ...
    /// </summary>
    public static readonly Guid Stage1 = new(0xaf019eb6, 0x1ba7, 0x40c4, 0xab, 0x2e, 0x74, 0xc0, 0xc8, 0x61, 0x9f, 0x75);

    // {C0C1465A-4149-414E-ADF8-AEAD3254187C}
    /// <summary>
    /// Indicates that the file is in Stage 2.
    /// </summary>
    public static readonly Guid Stage2 = new(0xc0c1465a, 0x4149, 0x414e, 0xad, 0xf8, 0xae, 0xad, 0x32, 0x54, 0x18, 0x7c);

    // {1B192006-C3E8-48D8-8F20-1AEB45577DDD}
    /// <summary>
    /// Indicates that the file is in Stage 3.
    /// </summary>
    public static readonly Guid Stage3 = new(0x1b192006, 0xc3e8, 0x48d8, 0x8f, 0x20, 0x1a, 0xeb, 0x45, 0x57, 0x7d, 0xdd);

    // {8E325F41-0DB9-4E7C-9209-6DACF40D7C89}
    /// <summary>
    /// Indicates that the file is in Stage 4.
    /// </summary>
    public static readonly Guid Stage4 = new(0x8e325f41, 0x0db9, 0x4e7c, 0x92, 0x09, 0x6d, 0xac, 0xf4, 0x0d, 0x7c, 0x89);

    // {21C048D7-D51F-4372-B90B-AC859B0A406E}
    /// <summary>
    /// Indicates that the file is in Stage 5.
    /// </summary>
    public static readonly Guid Stage5 = new(0x21c048d7, 0xd51f, 0x4372, 0xb9, 0x0b, 0xac, 0x85, 0x9b, 0x0a, 0x40, 0x6e);

    // {23C433B7-90E9-48FB-8616-0392CAA528D9}
    /// <summary>
    /// Indicates that the file is in Stage 6.
    /// </summary>
    public static readonly Guid Stage6 = new(0x23c433b7, 0x90e9, 0x48fb, 0x86, 0x16, 0x03, 0x92, 0xca, 0xa5, 0x28, 0xd9);

    // {B2580D7C-102A-4B52-BC43-8E7078521AEA}
    /// <summary>
    /// Indicates that the file is in Stage 7.
    /// </summary>
    public static readonly Guid Stage7 = new(0xb2580d7c, 0x102a, 0x4b52, 0xbc, 0x43, 0x8e, 0x70, 0x78, 0x52, 0x1a, 0xea);
    ...
    /// </summary>
    public static readonly Guid Stage9 = new(0xb5a3fbc4, 0x285a, 0x4559, 0xa3, 0xea, 0x09, 0x40, 0x21, 0x96, 0x77, 0xf8);
    ...
    /// </summary>
    public static readonly Guid ManualRollover = new(0x4af94839, 0xe4fa, 0x4cbd, 0x8b, 0x41, 0xe8, 0x45, 0x72, 0x74, 0xa5, 0x94);
